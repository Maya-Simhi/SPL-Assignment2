...
public class Main {
    ...
    public static void main(String[] args) {
      ...
      //  Config config = new Config(logger, "/Users/msimhi/private/spl/spl2/mine/Set_Card_Game/src/main/resources/config.properties");//todo change this back
